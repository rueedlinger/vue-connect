    ...
    <div class="box" v-if="status.connector">
     ...
     <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td>State</td>
            <td><button v-bind:class="status.connector.state " class="button is-rounded is-small">{{ status.connector.state  }}</button></td>
          </tr>
      </tbody>
    </table>
       ...
       <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <tr>
            <td>State</td>
            <td><button v-bind:class="task.state" class="button is-rounded is-small">{{ task.state }}</button></td>
          </tr>
      </tbody>
    </table>
